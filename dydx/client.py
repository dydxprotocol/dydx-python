...
class Client(object):
    ...
    def set_allowance(
        ...
        '''
        Deprecated. Use eth.set_allowance() instead.
        '''
    ...
    def deposit(
        ...
        '''
        Deprecated. Use eth.deposit() instead.
        '''
        return self.eth.deposit(
            market=market,
            wei=wei
        )
    ...
    def withdraw(
        ...
        '''
        Deprecated. Use eth.withdraw() instead.
        '''
        return self.eth.withdraw(
            market=market,
            wei=wei,
            to=to
        )
    ...
    def withdraw_to_zero(
        ...
        '''
        Deprecated. Use eth.withdraw_to_zero() instead.
        '''
        return self.eth.withdraw_to_zero(
            market=market,
            to=to
        )
    ...
    def get_receipt(
        ...
        '''
        Deprecated. Use eth.get_receipt() instead.
        '''
        return self.eth.get_receipt(
            tx_hash=tx_hash
        )
